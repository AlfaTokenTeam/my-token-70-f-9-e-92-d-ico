...
import "./MyToken70F9E92D.sol";

contract MyToken70F9E92DPreSale {
    MyToken70F9E92D public token;
    ...
    function MyToken70F9E92DPreSale(
        MyToken70F9E92D _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken70F9E92D(_token);
